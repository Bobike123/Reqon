...
export const TUTORIAL_STEPS: TutorialStep[] = [
  ...
  },
  {
    ...
    route: '/',
    target: 'now-topics',
    title: 'Topics, right from Now',
    body: 'Topics that are raised, on the agenda or decided show here too, so you can raise or update one without leaving Now. It is the same list as Meetings.',
  },
  ...
  },
  {
    ...
    target: 'board-card',
    title: 'A task',
    body: 'Move a task with its first dropdown and give it an owner with the second. A red due date means overdue. “From topic” names the meeting topic it came from.',
  },
  ...
  // ------------------------------------------------------------------ Meetings
  {
    ...
    route: '/meetings',
    target: 'topic-raise',
    title: 'Meetings — raise a topic',
    body: 'Anything the team needs to decide. A short title is enough; add context if it helps. Anyone on the roster can raise one, here or on Now.',
  },
  {
    id: 'topic-flow',
    chapter: 'meetings',
    route: '/meetings',
    target: 'topic-flow',
    title: 'How a topic moves',
    body: 'Raised, then On the agenda, then Decided, with how many topics are at each stage right now. Parked sets a topic aside without deleting it.',
  },
  {
    id: 'topic-card',
    chapter: 'meetings',
    ...
    target: 'topic-card',
    title: 'A topic',
    body: 'Set the topic’s stage and owner with the two dropdowns. Before a meeting, move what you want to discuss to “On the agenda”.',
  },
  {
    id: 'topic-decision',
    chapter: 'meetings',
    route: '/meetings',
    target: 'topic-decision',
    title: 'Write the decision',
    body: 'What was decided, and why. It saves when you click away and stays editable at every stage, so a decision can be corrected later.',
  },
  {
    id: 'topic-convert',
    chapter: 'meetings',
    route: '/meetings',
    target: 'topic-convert',
    title: 'From decision to task',
    body: '“Convert to task” puts the decision on the Board in To do. A topic converts once; after that its card links to the task instead.',
  },
